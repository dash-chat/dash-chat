...
2. Install Node.js 24 (see `.node-version`). If you use [asdf](https://asdf-vm.com/), add `legacy_version_file = yes` to `~/.asdfrc` so that `asdf install` picks up `.node-version`.
