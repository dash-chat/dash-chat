 ...
 * the screen and rebuilds it on return. Coming straight back lands while the
 * teardown is still closing the node's endpoint (up to 3s), so the reopened
 * chat asks for its photos before the node is back.
 */
